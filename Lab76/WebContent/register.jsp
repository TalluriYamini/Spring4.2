...
<body>
	<center>
		<form:form action="registerStudent.mvc" method="post"
			commandName="student">
			<table>
				<tr>
				...
				<tr>
					...
					<td><form:checkbox path="timings" value="07.30A.M - 9.30A.M" />07.30A.M
						- 9.30A.M<br> <form:checkbox path="timings"
							value="10.30A.M - 02.30P.M" />10.30A.M - 02.30P.M<br> <form:checkbox
							path="timings" value="04.00A.M - 06.00P.M" />04.00A.M - 06.00P.M<br>
						<form:checkbox path="timings" value="06.30A.M - 08.30P.M" />06.30A.M
						- 08.30P.M<br> <form:checkbox path="timings" value="Weekends" />Weekends(Only
						Advance)<br></td>
